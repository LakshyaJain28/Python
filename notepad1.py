"""
Created on Tue May 31 18:17:04 2022
...
open_button=Button(root,text="Open File",image=open_img ,command=openFile)
...
exit_button=Button(root,text="Exit",image=exit_img,command=closeWindow)
